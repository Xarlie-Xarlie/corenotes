  ...
  it('should enforce description length validation', async () => {
    await assert.rejects(
      ...
      (err) => {
        ...
        assert.strictEqual(
          err.message,
          'Validation error: Description must be between 1 and 10000 characters long',
        )
        return true
      },
    )
  ...
  it('should not create a note with invalid color', async () => {
    await assert.rejects(
      ...
      (err) => {
        ...
        assert.strictEqual(
          err.message,
          'invalid input value for enum "enum_Notes_color": "asdf"',
        )
        return true
      },
    )
  ...
  it("shouldn't update to an invalid color", async () => {
    ...
    await assert.rejects(
      ...
      (err) => {
        ...
        assert.strictEqual(
          err.message,
          'invalid input value for enum "enum_Notes_color": "testColor"',
        )
        return true
      },
    )
